...
Встроенное обновление принимает установщик только из официального репозитория и обязательно сверяет SHA-256 после скачивания, при чтении из кэша и перед запуском UAC.
